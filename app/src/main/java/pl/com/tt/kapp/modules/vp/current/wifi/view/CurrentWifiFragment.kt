package pl.com.tt.kapp.modules.vp.current.wifi.view
...
import pl.com.tt.kapp.modules.model.wifi.WifiAdapter
import pl.com.tt.kapp.modules.model.wifi.WifiReceiver
import pl.com.tt.kapp.modules.vp.current.wifi.presenter.WifiPresenter
...
class CurrentWifiFragment : Fragment(), WifiMVP.View {
    ...
    override fun updateData(networks: ScanDTO) {
